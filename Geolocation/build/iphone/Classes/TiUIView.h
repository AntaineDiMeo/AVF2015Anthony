...
/**
 Base class for all Geolocation views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Geolocation view hierarchy (such as wrapped iOS UIViews) was touched.
