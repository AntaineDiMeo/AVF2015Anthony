...
@interface GeolocationObject : KrollCoverageObject {
#else
@interface GeolocationObject : KrollObject {
#endif
@private
...
extern NSString * Geolocation$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	GeolocationObject *_geolocation;
    KrollObject* console;
	BOOL shutdown;
