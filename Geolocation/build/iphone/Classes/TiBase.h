...
// in simulator we redefine to format for Geolocation Developer console
...
{\
	NSString * exceptionName = [@"org.geolocation." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.geolocation";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIGeolocationNativeItemNone = -1, 
	UIGeolocationNativeItemSpinner = -2,
	UIGeolocationNativeItemProgressBar = -3,
	
	UIGeolocationNativeItemSlider = -4,
	UIGeolocationNativeItemSwitch = -5,
	UIGeolocationNativeItemMultiButton = -6,
	UIGeolocationNativeItemSegmented = -7,
	
	UIGeolocationNativeItemTextView = -8,
	UIGeolocationNativeItemTextField = -9,
	UIGeolocationNativeItemSearchBar = -10,
	
	UIGeolocationNativeItemPicker = -11,
	UIGeolocationNativeItemDatePicker = -12,
	
	UIGeolocationNativeItemInfoLight = -13,
	UIGeolocationNativeItemInfoDark = -14,
	
	UIGeolocationNativeItemDisclosure = -15,
	
	UIGeolocationNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Geolocation instances of
