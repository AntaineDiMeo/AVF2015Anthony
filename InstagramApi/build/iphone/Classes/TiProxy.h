...
//Rare exceptions to indicate a bug in the _instagramapi code (Eg, function that a subclass should have implemented)
...
/**
 The base class for InstagramApi proxies.
 */
