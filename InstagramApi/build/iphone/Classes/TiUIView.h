...
/**
 Base class for all InstagramApi views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the InstagramApi view hierarchy (such as wrapped iOS UIViews) was touched.
