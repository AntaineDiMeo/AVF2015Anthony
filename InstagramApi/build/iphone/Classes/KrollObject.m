...
//@interface InstagramApiObject : NSObject
//@end

@interface InstagramApiObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[InstagramApiObject class]])
		{
			for (NSString *key in [[(InstagramApiObject*)o modules] allKeys])
			{
