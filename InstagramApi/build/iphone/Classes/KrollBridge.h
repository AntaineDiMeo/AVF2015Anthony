...
@interface InstagramApiObject : KrollCoverageObject {
#else
@interface InstagramApiObject : KrollObject {
#endif
@private
...
extern NSString * InstagramApi$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	InstagramApiObject *_instagramapi;
    KrollObject* console;
	BOOL shutdown;
