...
// in simulator we redefine to format for InstagramApi Developer console
...
{\
	NSString * exceptionName = [@"org.instagramapi." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.instagramapi";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIInstagramApiNativeItemNone = -1, 
	UIInstagramApiNativeItemSpinner = -2,
	UIInstagramApiNativeItemProgressBar = -3,
	
	UIInstagramApiNativeItemSlider = -4,
	UIInstagramApiNativeItemSwitch = -5,
	UIInstagramApiNativeItemMultiButton = -6,
	UIInstagramApiNativeItemSegmented = -7,
	
	UIInstagramApiNativeItemTextView = -8,
	UIInstagramApiNativeItemTextField = -9,
	UIInstagramApiNativeItemSearchBar = -10,
	
	UIInstagramApiNativeItemPicker = -11,
	UIInstagramApiNativeItemDatePicker = -12,
	
	UIInstagramApiNativeItemInfoLight = -13,
	UIInstagramApiNativeItemInfoDark = -14,
	
	UIInstagramApiNativeItemDisclosure = -15,
	
	UIInstagramApiNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all InstagramApi instances of
